<nav class="navbar navbar-expand-lg navbar-dark bg-dark mb-5">
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php"><img src="./gnt_img/gntlogo.jpeg" alt="Gnt logo" width="32px" height="32px"></a>
    ...
    <form class="modal-content" method="POST" action="updateProfile.php" enctype="multipart/form-data">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="Name" name="uname" value="<?php echo $_SESSION["name"]; ?>">
        </div>
        <div class="mb-3">
          <label for="inputEmail" class="form-label">Email address</label>
          <input type="email" class="form-control" id="inputEmail" name="email" value="<?php echo $_SESSION["email"]; ?>" disabled aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
